...
- **[The flat-session protocol](/explanation/flat-session-protocol)** — how the browser endpoint's explicit Sessions and direct Target sockets share one Host-owned Session model.
